/*
  # Fix Admin User Role Cache
  
  1. Changes
    - Adds ON CONFLICT clause to role_cache insert
    - Uses existing admin ID to avoid duplicates
    - Ensures proper role assignment
  
  2. Security
    - Maintains existing security settings
    - Preserves admin permissions
*/
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    'diego.martinez@kodigo.org',
    crypt('DiegoDev2025!', gen_salt('bf')),
    now(),
    'admin',
    'authenticated',
